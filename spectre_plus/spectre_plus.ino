...
//    ble.sendCommandCheckOK("AT+GAPDEVNAME=myname" );
    ble.println("AT+GAPDEVNAME=Spectre Plus 1");
    ble.waitForOK();

//    ble.println("AT+NAME=Spectre Plus 2");
...
void loop(void)
{
//    ble.println("AT+GAPDEVNAME=Spectre Plus 2");
  
  // triangular wave or chainsaw wave
  sig += 0.5;
